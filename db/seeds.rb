...
BILLING = [
  {
    first_name: "Mike",   last_name: "Brady", email: "mbrady@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
    first_name: "Carol",  last_name: "Brady", email: "cbrady@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
    first_name: "Alice",  last_name: "Nelson", email: "anelson@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
    first_name: "Greg",   last_name: "Brady", email: "gbrady@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
    first_name: "Marcia", last_name: "Brady", email: "mlbrady@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
    first_name: "Peter",  last_name: "Brady", email: "pbrady@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
    first_name: "Jan",    last_name: "Brady", email: "jbrady@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
    first_name: "Bobby",  last_name: "Brady", email: "bbrady@tv.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "123 Sunshine St", address2: Suite 8, city: "Seattle", state: "WA",
    zip: 12345, user_id: 2
  }
  {
  ...
  {
    first_name: "Jude",  last_name: "Queso", email: "im_the_man@boss.com", credit_card: 4444555566667777,
    cvv: 123, billing_zip: 54321, address1: "888 Wow Dr", address2: , city: "Costa Mesa", state: "CA",
    zip: 78787
  }
]
...
ORDER_ITEMS = [
  {
    quanity: 1, name: "product3", price: 1.50, status: "pending", order_id: 1, product_id: 3
  }
  {
    quanity: 2, name: "product5", price: 3.00, status: "pending", order_id: 2, product_id: 5
  }
  {
    quanity: 1, name: "product3", price: 1.50, status: "pending", order_id: 3, product_id: 3
  }
  {
    quanity: 1, name: "product2", price: 1.50, status: "pending", order_id: 4, product_id: 2
  }
  {
    quanity: 1, name: "product4", price: 1.50, status: "pending", order_id: 5, product_id: 4
  }
]
